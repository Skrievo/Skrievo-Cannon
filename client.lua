...
RegisterNetEvent('skrievo_cannon:spawncannon')
AddEventHandler('skrievo_cannon:spawncannon', function(type)
    if type == 1 then 
...
RegisterNetEvent('skrievo_cannon:rotate')
AddEventHandler('skrievo_cannon:rotate', function(rotation)
    if car ~= nil then 
